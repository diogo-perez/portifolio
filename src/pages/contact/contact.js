...
const Contact = () => {
    ...
    return (
        <div className="bg-black h-screen flex flex-col justify-center items-center text-white">
            ...
            <p className="mt-1 text-center mb-2 p-2">Tem um projeto em mente ou apenas quer dizer oi? Sinta-se livre para me enviar uma mensagem!</p>
            <form className="pl-5 pr-5 w-full max-w-md">
                <div className="mb-4">
                ...
                <div className="mb-4">
                    ...
                    <input type="text" id="contact" name="contact" value={formData.contact} onChange={handleChange} className="mt-1 p-2 border border-gray-300 rounded-md w-full focus:outline-none focus:border-green-500 text-black" required />
                </div>
                <div className="mb-4">
